...
void RayleighNewmark::assemble_resistance() {
	...
	suanpan_for_each(element_pool.cbegin(), element_pool.cend(), [&](const shared_ptr<Element>& t_element) { suanpan::damping::rayleigh::apply(t_element, damping_alpha, damping_beta, damping_zeta); });
