...
template<typename eT> inline SpSubview<eT>::iterator_base::iterator_base(const SpSubview<eT>& in_M)
	: M(&in_M)
	, internal_col(0)
	, internal_pos(0) {
...
template<typename eT> inline SpSubview<eT>::iterator_base::iterator_base(const SpSubview<eT>& in_M, const uword in_col, const uword in_pos)
	: M(&in_M)
	, internal_col(in_col)
	, internal_pos(in_pos) {
	// Nothing to do.
...
template<typename eT> inline SpSubview<eT>::const_iterator::const_iterator(const SpSubview<eT>& in_M, const uword initial_pos)
...
template<typename eT> inline SpSubview<eT>::const_iterator::const_iterator(const SpSubview<eT>& in_M, const uword in_row, const uword in_col)
...
template<typename eT> inline SpSubview<eT>::const_iterator::const_iterator(const SpSubview<eT>& in_M, uword in_row, uword in_col, uword in_pos, uword in_skip_pos)
...
template<typename eT> inline SpSubview<eT>::const_iterator::const_iterator(const const_iterator& other)
...
eT SpSubview<eT>::const_iterator::operator*() const { return iterator_base::M->m.values[iterator_base::internal_pos + skip_pos]; }

template<typename eT> inline
arma_hot
typename SpSubview<eT>::const_iterator& SpSubview<eT>::const_iterator::operator++() {
	const uword aux_col = iterator_base::M->aux_col1;
	const uword aux_row = iterator_base::M->aux_row1;
	const uword ln_rows = iterator_base::M->n_rows;
	const uword ln_cols = iterator_base::M->n_cols;
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_iterator::operator==(const const_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_iterator::operator==(const typename SpMat<eT>::const_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_iterator::operator==(const const_row_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_iterator::operator==(const typename SpMat<eT>::const_row_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
SpValProxy<SpSubview<eT>> SpSubview<eT>::iterator::operator*() {
...
template<typename eT> inline
arma_hot
typename SpSubview<eT>::iterator& SpSubview<eT>::iterator::operator++() {
...
template<typename eT> inline
arma_warn_unused
typename SpSubview<eT>::iterator SpSubview<eT>::iterator::operator++(int) {
...
template<typename eT> inline SpSubview<eT>::const_row_iterator::const_row_iterator()
	: iterator_base()
	, internal_row(0)
	, actual_pos(0) { }

template<typename eT> inline SpSubview<eT>::const_row_iterator::const_row_iterator(const SpSubview<eT>& in_M, uword initial_pos)
	: iterator_base(in_M, 0, initial_pos)
	, internal_row(0)
	, actual_pos(0) {
...
template<typename eT> inline SpSubview<eT>::const_row_iterator::const_row_iterator(const SpSubview<eT>& in_M, uword in_row, uword in_col)
	: iterator_base(in_M, in_col, 0)
	, internal_row(0)
	, actual_pos(0) {
...
template<typename eT> inline SpSubview<eT>::const_row_iterator::const_row_iterator(const const_row_iterator& other)
	: iterator_base(*other.M, other.internal_col, other.internal_pos)
...
template<typename eT> inline
arma_hot
typename SpSubview<eT>::const_row_iterator& SpSubview<eT>::const_row_iterator::operator++() {
...
template<typename eT> inline
arma_warn_unused
typename SpSubview<eT>::const_row_iterator SpSubview<eT>::const_row_iterator::operator++(int) {
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_row_iterator::operator==(const const_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_row_iterator::operator==(const typename SpMat<eT>::const_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_row_iterator::operator==(const const_row_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
bool SpSubview<eT>::const_row_iterator::operator==(const typename SpMat<eT>::const_row_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }
...
template<typename eT> inline
arma_hot
SpValProxy<SpSubview<eT>> SpSubview<eT>::row_iterator::operator*() {
	return SpValProxy<SpSubview<eT>>(
...
template<typename eT> inline
arma_hot
typename SpSubview<eT>::row_iterator& SpSubview<eT>::row_iterator::operator++() {
...
template<typename eT> inline
arma_warn_unused
typename SpSubview<eT>::row_iterator SpSubview<eT>::row_iterator::operator++(int) {
