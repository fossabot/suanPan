...
template<typename eT> inline
void SpMat_MapMat_val<eT>::set(const eT in_val) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
void SpMat_MapMat_val<eT>::add(const eT in_val) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
void SpMat_MapMat_val<eT>::sub(const eT in_val) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
void SpMat_MapMat_val<eT>::mul(const eT in_val) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
void SpMat_MapMat_val<eT>::div(const eT in_val) {
	arma_extra_debug_sigprint();
...
template<typename eT> arma_inline SpSubview_MapMat_val<eT>::SpSubview_MapMat_val(SpSubview<eT>& in_sv_parent, MapMat<eT>& in_m_parent, const uword in_row, const uword in_col)
