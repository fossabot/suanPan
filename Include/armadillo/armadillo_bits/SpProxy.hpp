...
template<typename eT> class SpProxy<SpSubview_col<eT>> {
public:
...
template<typename eT, typename T1> class SpProxy<SpSubview_col_list<eT, T1>> {
public:
...
template<typename eT> class SpProxy<SpSubview_row<eT>> {
public:
...
template<typename out_eT, typename T1, typename T2, typename spglue_type> class SpProxy<mtSpGlue<out_eT, T1, T2, spglue_type>> {
public:
