...
template<typename T1> inline
void op_vectorise_col::apply_direct(Mat<typename T1::elem_type>& out, const T1& expr) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_vectorise_row::apply_direct(Mat<typename T1::elem_type>& out, const T1& expr) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_vectorise_cube_col::apply(Mat<typename T1::elem_type>& out, const CubeToMatOp<T1, op_vectorise_cube_col>& in) {
	arma_extra_debug_sigprint();
