...
void op_resize::apply(Mat<typename T1::elem_type>& actual_out, const Op<T1, op_resize>& in) {
...
template<typename T1> inline
void op_resize::apply(Cube<typename T1::elem_type>& actual_out, const OpCube<T1, op_resize>& in) {
	arma_extra_debug_sigprint();
