...
public:
	...
	template<typename eT2> constexpr bool has_overlap(const subview<eT2>&) const { return false; }
...
template<typename T1, typename op_type> class Proxy<CubeToMatOp<T1, op_type>> {
public:
...
template<typename T1> class Proxy<CubeToMatOp<T1, op_vectorise_cube_col>> {
public:
...
template<typename T1, typename op_type> class Proxy<SpToDOp<T1, op_type>> {
public:
...
template<typename T1> class Proxy<SpToDOp<T1, op_nonzeros_spmat>> {
public:
...
template<typename T1> class Proxy<Op<T1, op_diagvec2>> {
public:
