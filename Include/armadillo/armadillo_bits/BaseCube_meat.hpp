...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool BaseCube<elem_type, derived>::is_zero(const typename get_pod_type<elem_type>::result tol) const {
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool BaseCube<elem_type, derived>::is_empty() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool BaseCube<elem_type, derived>::is_finite() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool BaseCube<elem_type, derived>::has_inf() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool BaseCube<elem_type, derived>::has_nan() const {
	arma_extra_debug_sigprint();
