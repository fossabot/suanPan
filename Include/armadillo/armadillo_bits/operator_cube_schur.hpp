...
const eGlueCube<T1, T2, eglue_schur> operator%
(
...
const mtGlueCube<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, glue_mixed_schur> operator%
(
