...
inline
arma_deprecated
uword memory::enlarge_to_mult_of_chunksize(const uword n_elem) //! NOTE: do not use this function; it will be removed
{
	return n_elem;
}
...
template<typename eT> inline
arma_deprecated
eT* memory::acquire_chunked(const uword n_elem) //! NOTE: do not use this function; it will be removed
{
