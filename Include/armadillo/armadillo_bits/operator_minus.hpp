...
<
	...
	const mtOp<typename std::complex<typename T1::pod_type>, T1, op_cx_scalar_minus_pre>>::result operator-
(
...
<
	(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::no),
	const mtOp<typename std::complex<typename T1::pod_type>, T1, op_cx_scalar_minus_post>>::result operator-
(
	const T1& X,
	const std::complex<typename T1::pod_type>& k
) {
...
<
	...
	const eGlue<T1, T2, eglue_minus>>::result operator-
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const mtGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, glue_mixed_minus>>::result operator-
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const SpGlue<T1, T2, spglue_minus>>::result operator-
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const mtSpGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, spglue_minus_mixed>>::result operator-
(
	const T1& X,
	const T2& Y
) {
...
template<typename T1> arma_inline
typename
enable_if2<is_arma_sparse_type<T1>::value, const SpToDOp<T1, op_sp_minus_post>>::result operator-
(
	const T1& X,
	const typename T1::elem_type k
) {
...
template<typename T1> arma_inline
typename
enable_if2<is_arma_sparse_type<T1>::value, const SpToDOp<T1, op_sp_minus_pre>>::result operator-
(
	const typename T1::elem_type k,
	const T1& X
) {
...
<
	...
	const SpToDOp<T1, op_sp_minus_post>>::result operator-
(
...
<
	(is_arma_sparse_type<T1>::value &&
		(is_same_type<op_type, op_sp_plus>::value ||
			is_same_type<op_type, op_sp_minus_post>::value)),
	const SpToDOp<T1, op_sp_minus_pre>>::result operator-
(
	const typename T1::elem_type k,
	const SpToDOp<T1, op_type>& x
) {
...
<
	(is_arma_sparse_type<T1>::value &&
		is_same_type<op_type, op_sp_minus_pre>::value),
	const SpToDOp<T1, op_sp_plus>>::result operator-
(
	const typename T1::elem_type k,
	const SpToDOp<T1, op_type>& x
) {
