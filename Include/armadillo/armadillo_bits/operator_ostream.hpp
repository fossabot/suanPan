...
template<typename eT, typename T1> inline
std::ostream& operator<<(std::ostream& o, const SpBase<eT, T1>& X) {
	arma_extra_debug_sigprint();
...
std::ostream& operator<<(std::ostream& o, const SpValProxy<T1>& X) {
	arma_extra_debug_sigprint();
...
std::ostream& operator<<(std::ostream& o, const MapMat_val<eT>& X) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
std::ostream& operator<<(std::ostream& o, const SpMat_MapMat_val<eT>& X) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
std::ostream& operator<<(std::ostream& o, const SpSubview_MapMat_val<eT>& X) {
	arma_extra_debug_sigprint();
...
inline
std::ostream& operator<<(std::ostream& o, const SizeMat& S) {
	arma_extra_debug_sigprint();
...
inline
std::ostream& operator<<(std::ostream& o, const SizeCube& S) {
	arma_extra_debug_sigprint();
