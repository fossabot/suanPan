...
template<typename T1, bool sort_stable> inline
bool arma_sort_index_helper(Mat<uword>& out, const Proxy<T1>& P, const uword sort_type) {
...
bool op_sort_index::apply_noalias(Mat<uword>& out, const Proxy<T1>& P, const uword sort_type) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_sort_index::apply(Mat<uword>& out, const mtOp<uword, T1, op_sort_index>& in) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool op_stable_sort_index::apply_noalias(Mat<uword>& out, const Proxy<T1>& P, const uword sort_type) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_stable_sort_index::apply(Mat<uword>& out, const mtOp<uword, T1, op_stable_sort_index>& in) {
	arma_extra_debug_sigprint();
