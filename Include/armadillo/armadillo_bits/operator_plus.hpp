...
<
	...
	const mtOp<typename std::complex<typename T1::pod_type>, T1, op_cx_scalar_plus>>::result operator+
(
	const T1& X,
...
<
	...
	const eGlue<T1, T2, eglue_plus>>::result operator+
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const mtGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, glue_mixed_plus>>::result operator+
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const mtSpGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, spglue_plus_mixed>>::result operator+
(
	const T1& X,
	const T2& Y
) {
...
typename enable_if2<is_arma_sparse_type<T1>::value, const SpToDOp<T1, op_sp_plus>>::result operator+
(
	const T1& X,
