...
template<typename eT> arma_hot
inline
void arrayops::clean(eT* mem, const uword n_elem, const eT abs_limit, const typename arma_not_cx<eT>::result* junk) {
	arma_ignore(junk);
...
inline
void arrayops::clean(std::complex<T>* mem, const uword n_elem, const T abs_limit) {
...
template<typename eT> arma_hot
inline
void arrayops::inplace_set_simple(eT* dest, const eT val, const uword n_elem) {
	if(memory::is_aligned(dest)) {
		memory::mark_as_aligned(dest);
...
template<typename eT> arma_hot
inline
bool arrayops::is_zero(const eT* mem, const uword n_elem, const eT abs_limit, const typename arma_not_cx<eT>::result* junk) {
	arma_ignore(junk);
...
template<typename T> arma_hot
inline
bool arrayops::is_zero(const std::complex<T>* mem, const uword n_elem, const T abs_limit) {
	typedef typename std::complex<T> eT;
