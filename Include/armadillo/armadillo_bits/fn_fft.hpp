...
<
	...
	const mtOp<std::complex<typename T1::pod_type>, T1, op_fft_real>>::result fft(const T1& A) {
...
<
	(is_arma_type<T1>::value && is_real<typename T1::elem_type>::value),
	const mtOp<std::complex<typename T1::pod_type>, T1, op_fft_real>>::result fft(const T1& A, const uword N) {
	arma_extra_debug_sigprint();
...
<
	...
	const Op<T1, op_fft_cx>>::result fft(const T1& A) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx_float<typename T1::elem_type>::yes || is_cx_double<typename T1::elem_type>::yes)),
	const Op<T1, op_fft_cx>>::result fft(const T1& A, const uword N) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx_float<typename T1::elem_type>::yes || is_cx_double<typename T1::elem_type>::yes)),
	const Op<T1, op_ifft_cx>>::result ifft(const T1& A) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx_float<typename T1::elem_type>::yes || is_cx_double<typename T1::elem_type>::yes)),
	const Op<T1, op_ifft_cx>>::result ifft(const T1& A, const uword N) {
	arma_extra_debug_sigprint();
