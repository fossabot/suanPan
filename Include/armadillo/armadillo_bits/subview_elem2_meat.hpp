...
void subview_elem2<eT, T1, T2>::replace(const eT old_val, const eT new_val) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1, typename T2> inline
void subview_elem2<eT, T1, T2>::clean(const pod_type threshold) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1, typename T2> template<typename expr> inline
void subview_elem2<eT, T1, T2>::operator=(const SpBase<eT, expr>& x) {
	arma_extra_debug_sigprint();
