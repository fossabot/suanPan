...
void op_reshape::apply_unwrap(Mat<eT>& out, const Mat<eT>& A, const uword in_n_rows, const uword in_n_cols) {
...
template<typename T1> inline
void op_reshape::apply(Cube<typename T1::elem_type>& out, const OpCube<T1, op_reshape>& in) {
	arma_extra_debug_sigprint();
...
inline
void op_reshape_old::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_reshape_old>& in) {
	arma_extra_debug_sigprint();
