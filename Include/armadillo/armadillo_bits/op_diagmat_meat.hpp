...
template<typename T1> inline
void op_diagmat::apply(Mat<typename T1::elem_type>& out, const Proxy<T1>& P) {
	arma_extra_debug_sigprint();
...
void op_diagmat::apply(Mat<typename T1::elem_type>& out, const Op<Glue<T1, T2, glue_times>, op_diagmat>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void op_diagmat::apply_times(Mat<typename T1::elem_type>& actual_out, const T1& X, const T2& Y, const typename arma_not_cx<typename T1::elem_type>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename T1, typename T2> inline
void op_diagmat::apply_times(Mat<typename T1::elem_type>& actual_out, const T1& X, const T2& Y, const typename arma_cx_only<typename T1::elem_type>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
