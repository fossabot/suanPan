...
inline
void arma_rng_cxx98::set_seed(const arma_rng_cxx98::seed_type val) { std::srand(val); }

arma_inline
int arma_rng_cxx98::randi_val() {
#if (RAND_MAX == 32767)
	{
...
arma_inline
double arma_rng_cxx98::randu_val() { return double(double(randi_val()) * (double(1) / double(randi_max_val()))); }

inline
double arma_rng_cxx98::randn_val() {
...
void arma_rng_cxx98::randn_dual_val(eT& out1, eT& out2) {
...
inline
int arma_rng_cxx98::randi_max_val() {
#if (RAND_MAX == 32767)
