...
namespace arma_str {
	...
	static
	const T1& str_wrapper(const T1& x, const typename string_only<T1>::result* junk = nullptr) {
		arma_ignore(junk);
	...
	template<typename T1> inline
	static
	const T1* str_wrapper(const T1* x, const typename char_only<T1>::result* junk = nullptr) {
		arma_ignore(junk);
	...
	template<typename T1> inline
	static
	std::string str_wrapper(const T1& x, const typename basic_format_only<T1>::result* junk = nullptr) {
		arma_ignore(junk);
