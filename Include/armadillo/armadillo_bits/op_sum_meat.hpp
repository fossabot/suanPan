...
inline
void op_sum::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_sum>& in) {
...
template<typename T1> arma_hot
inline
void op_sum::apply_noalias_unwrap(Mat<typename T1::elem_type>& out, const Proxy<T1>& P, const uword dim) {
	arma_extra_debug_sigprint();
	...
	if(dim == 0) {
		...
		for(uword col = 0; col < X_n_cols; ++col) { arrayops::inplace_plus(out_mem, X.colptr(col), X_n_rows); }
	}
}

template<typename T1> arma_hot
inline
void op_sum::apply_noalias_proxy(Mat<typename T1::elem_type>& out, const Proxy<T1>& P, const uword dim) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_sum::apply_noalias_proxy_mp(Mat<typename T1::elem_type>& out, const Proxy<T1>& P, const uword dim) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_sum::apply(Cube<typename T1::elem_type>& out, const OpCube<T1, op_sum>& in) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_sum::apply_noalias_unwrap(Cube<typename T1::elem_type>& out, const ProxyCube<T1>& P, const uword dim) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_sum::apply_noalias_proxy(Cube<typename T1::elem_type>& out, const ProxyCube<T1>& P, const uword dim) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_sum::apply_noalias_proxy_mp(Cube<typename T1::elem_type>& out, const ProxyCube<T1>& P, const uword dim) {
	arma_extra_debug_sigprint();
