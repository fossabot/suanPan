...
template<typename T1, typename T2, typename glue_type, bool condition> struct Glue_traits {};

template<typename T1, typename T2, typename glue_type> struct Glue_traits<T1, T2, glue_type, true> {
...
template<typename T1, typename T2, typename glue_type> struct Glue_traits<T1, T2, glue_type, false> {
