...
<
	...
	const eGlue<T1, T2, eglue_schur>>::result operator%
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const mtGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, glue_mixed_schur>>::result operator%
(
	const T1& X,
	const T2& Y
) {
...
<
	...
	const mtSpGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, spglue_schur_mixed>>::result operator%
(
	const T1& X,
	const T2& Y
) {
