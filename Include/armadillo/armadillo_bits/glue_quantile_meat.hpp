...
template<typename eTa, typename eTb> inline
void glue_quantile::worker(eTb* out_mem, Col<eTa>& Y, const Mat<eTb>& P) {
...
template<typename eTa, typename eTb> inline
void glue_quantile::apply_noalias(Mat<eTb>& out, const Mat<eTa>& X, const Mat<eTb>& P, const uword dim) {
	arma_extra_debug_sigprint();
...
void glue_quantile::apply(Mat<typename T2::elem_type>& out, const mtGlue<typename T2::elem_type, T1, T2, glue_quantile>& expr) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void glue_quantile_default::apply(Mat<typename T2::elem_type>& out, const mtGlue<typename T2::elem_type, T1, T2, glue_quantile_default>& expr) {
	arma_extra_debug_sigprint();
