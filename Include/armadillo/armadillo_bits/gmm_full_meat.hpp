...
namespace gmm_priv {
	...
	template<typename eT> inline
	Row<eT> gmm_full<eT>::internal_vec_log_p(const Mat<eT>& X) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	Row<eT> gmm_full<eT>::internal_vec_log_p(const Mat<eT>& X, const uword gaus_id) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	eT gmm_full<eT>::internal_sum_log_p(const Mat<eT>& X) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	eT gmm_full<eT>::internal_sum_log_p(const Mat<eT>& X, const uword gaus_id) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	eT gmm_full<eT>::internal_avg_log_p(const Mat<eT>& X) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	eT gmm_full<eT>::internal_avg_log_p(const Mat<eT>& X, const uword gaus_id) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	uword gmm_full<eT>::internal_scalar_assign(const Mat<eT>& X, const gmm_dist_mode& dist_mode) const {
		arma_extra_debug_sigprint();
	...
	template<typename eT> inline
	void gmm_full<eT>::internal_vec_assign(urowvec& out, const Mat<eT>& X, const gmm_dist_mode& dist_mode) const {
		arma_extra_debug_sigprint();
