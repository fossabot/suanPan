...
void op_fft_real::apply(Mat<std::complex<typename T1::pod_type>>& out, const mtOp<std::complex<typename T1::pod_type>, T1, op_fft_real>& in) {
...
template<typename T1> inline
void op_fft_cx::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_fft_cx>& in) {
	arma_extra_debug_sigprint();
...
template<typename T1, bool inverse> inline
void op_fft_cx::apply_noalias(Mat<typename T1::elem_type>& out, const Proxy<T1>& P, const uword a, const uword b) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_fft_cx::copy_vec_unwrap(typename Proxy<T1>::elem_type* dest, const Proxy<T1>& P, const uword N) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_fft_cx::copy_vec_proxy(typename Proxy<T1>::elem_type* dest, const Proxy<T1>& P, const uword N) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_ifft_cx::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_ifft_cx>& in) {
	arma_extra_debug_sigprint();
