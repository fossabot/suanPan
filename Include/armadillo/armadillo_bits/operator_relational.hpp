...
<
	...
	const mtGlue<uword, T1, T2, glue_rel_lt>>::result operator<
...
<
	(is_arma_type<T1>::value && is_arma_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtGlue<uword, T1, T2, glue_rel_gt>>::result operator>
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && is_arma_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtGlue<uword, T1, T2, glue_rel_lteq>>::result operator<=
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && is_arma_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtGlue<uword, T1, T2, glue_rel_gteq>>::result operator>=
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	...
	const mtGlue<uword, T1, T2, glue_rel_eq>>::result operator==
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && is_arma_type<T2>::value),
	const mtGlue<uword, T1, T2, glue_rel_noteq>>::result operator!=
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && is_arma_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtGlue<uword, T1, T2, glue_rel_and>>::result operator&&
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && is_arma_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtGlue<uword, T1, T2, glue_rel_or>>::result operator||
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	...
	const mtOp<uword, T1, op_rel_lt_pre>>::result operator<
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_lt_post>>::result operator<
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_gt_pre>>::result operator>
(const typename T1::elem_type val, const T1& X) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_gt_post>>::result operator>
(const T1& X, const typename T1::elem_type val) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_lteq_pre>>::result operator<=
(const typename T1::elem_type val, const T1& X) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_lteq_post>>::result operator<=
(const T1& X, const typename T1::elem_type val) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_gteq_pre>>::result operator>=
(const typename T1::elem_type val, const T1& X) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_type<T1>::value && (is_cx<typename T1::elem_type>::no)),
	const mtOp<uword, T1, op_rel_gteq_post>>::result operator>=
(const T1& X, const typename T1::elem_type val) {
	arma_extra_debug_sigprint();
...
<
	...
	const mtOp<uword, T1, op_rel_eq>>::result operator==
(const typename T1::elem_type val, const T1& X) {
	arma_extra_debug_sigprint();
...
<
	is_arma_type<T1>::value,
	const mtOp<uword, T1, op_rel_noteq>>::result operator!=
(const typename T1::elem_type val, const T1& X) {
	arma_extra_debug_sigprint();
...
<
	...
	const mtSpGlue<uword, T1, T2, spglue_rel_lt>>::result operator<
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_sparse_type<T1>::value && is_arma_sparse_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtSpGlue<uword, T1, T2, spglue_rel_gt>>::result operator>
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_sparse_type<T1>::value && is_arma_sparse_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtSpGlue<uword, T1, T2, spglue_rel_and>>::result operator&&
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
<
	(is_arma_sparse_type<T1>::value && is_arma_sparse_type<T2>::value && (is_cx<typename T1::elem_type>::no) && (is_cx<typename T2::elem_type>::no)),
	const mtSpGlue<uword, T1, T2, spglue_rel_or>>::result operator||
(const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
