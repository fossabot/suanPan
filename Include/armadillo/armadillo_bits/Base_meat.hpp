...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::is_zero(const typename get_pod_type<elem_type>::result tol) const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::is_trimatu() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::is_trimatl() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::is_diagmat() const {
	arma_extra_debug_sigprint();
	...
	for(uword A_col = 0; A_col < A_n_cols; ++A_col) {
		for(uword A_row = 0; A_row < A_n_rows; ++A_row) { if((A_mem[A_row] != elem_type(0)) && (A_row != A_col)) { return false; } }
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::is_finite() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::has_inf() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base<elem_type, derived>::has_nan() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base_extra_yes<elem_type, derived>::is_sympd() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool Base_extra_yes<elem_type, derived>::is_sympd(typename get_pod_type<elem_type>::result tol) const {
	arma_extra_debug_sigprint();
