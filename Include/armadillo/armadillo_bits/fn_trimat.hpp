...
arma_inline
const Op<T1, op_trimat> trimatu(const Base<typename T1::elem_type, T1>& X) {
...
template<typename T1> arma_warn_unused
arma_inline
const Op<T1, op_trimat> trimatl(const Base<typename T1::elem_type, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
arma_inline
const SpOp<T1, spop_trimat> trimatu(const SpBase<typename T1::elem_type, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
arma_inline
const SpOp<T1, spop_trimat> trimatl(const SpBase<typename T1::elem_type, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
arma_inline
const Op<T1, op_trimatl_ext> trimatl(const Base<typename T1::elem_type, T1>& X, const sword k) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
arma_inline
const Op<T1, op_trimatu_ext> trimatu(const Base<typename T1::elem_type, T1>& X, const sword k) {
	arma_extra_debug_sigprint();
