...
inline
uword SizeMat::operator[](const uword dim) const {
...
inline
bool SizeMat::operator==(const SizeMat& s) const {
...
inline
SizeMat SizeMat::operator+(const SizeMat& s) const { return SizeMat((n_rows + s.n_rows), (n_cols + s.n_cols)); }

inline
SizeMat SizeMat::operator-(const SizeMat& s) const {
...
inline
SizeMat SizeMat::operator+(const uword val) const { return SizeMat((n_rows + val), (n_cols + val)); }

inline
SizeMat SizeMat::operator-(const uword val) const {
