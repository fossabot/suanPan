...
template<typename eT> inline SpSubview<eT>::SpSubview(const SpMat<eT>& in_m, const uword in_row1, const uword in_col1, const uword in_n_rows, const uword in_n_cols)
	: m(in_m)
	, aux_row1(in_row1)
	, aux_col1(in_col1)
	, n_rows(in_n_rows)
...
template<typename eT> inline
void SpSubview<eT>::clean(const typename get_pod_type<eT>::result threshold) {
	arma_extra_debug_sigprint();
	...
	if(is_cx<eT>::yes) { (*this).operator=(tmp); } else if(tmp.n_nonzero != n_nonzero) { (*this).operator=(tmp); }
}
...
void SpSubview<eT>::zeros() {
	...
	for(uword i = 0; i < tmp.n_cols; ++i) { access::rw(tmp.col_ptrs[i + 1]) += tmp.col_ptrs[i]; }
...
template<typename eT> inline
SpSubview_row<eT> SpSubview<eT>::row(const uword row_num) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
const SpSubview_row<eT> SpSubview<eT>::row(const uword row_num) const {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
SpSubview_col<eT> SpSubview<eT>::col(const uword col_num) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
const SpSubview_col<eT> SpSubview<eT>::col(const uword col_num) const {
	arma_extra_debug_sigprint();
...
template<typename eT> inline SpSubview_col<eT>::SpSubview_col(const SpMat<eT>& in_m, const uword in_col)
	: SpSubview<eT>(in_m, 0, in_col, in_m.n_rows, 1) {
	arma_extra_debug_sigprint();
}

template<typename eT> inline SpSubview_col<eT>::SpSubview_col(const SpMat<eT>& in_m, const uword in_col, const uword in_row1, const uword in_n_rows)
	: SpSubview<eT>(in_m, in_row1, in_col, in_n_rows, 1) {
	arma_extra_debug_sigprint();
}

template<typename eT> inline
void SpSubview_col<eT>::operator=(const SpSubview<eT>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
void SpSubview_col<eT>::operator=(const SpSubview_col<eT>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> template<typename T1> inline
void SpSubview_col<eT>::operator=(const SpBase<eT, T1>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> template<typename T1> inline
void SpSubview_col<eT>::operator=(const Base<eT, T1>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
const SpOp<SpSubview_col<eT>, spop_htrans> SpSubview_col<eT>::t() const { return SpOp<SpSubview_col<eT>, spop_htrans>(*this); }

template<typename eT> inline
const SpOp<SpSubview_col<eT>, spop_htrans> SpSubview_col<eT>::ht() const { return SpOp<SpSubview_col<eT>, spop_htrans>(*this); }

template<typename eT> inline
const SpOp<SpSubview_col<eT>, spop_strans> SpSubview_col<eT>::st() const { return SpOp<SpSubview_col<eT>, spop_strans>(*this); }

//
//
//

template<typename eT> inline SpSubview_row<eT>::SpSubview_row(const SpMat<eT>& in_m, const uword in_row)
	: SpSubview<eT>(in_m, in_row, 0, 1, in_m.n_cols) {
	arma_extra_debug_sigprint();
}

template<typename eT> inline SpSubview_row<eT>::SpSubview_row(const SpMat<eT>& in_m, const uword in_row, const uword in_col1, const uword in_n_cols)
	: SpSubview<eT>(in_m, in_row, in_col1, 1, in_n_cols) {
	arma_extra_debug_sigprint();
}

template<typename eT> inline
void SpSubview_row<eT>::operator=(const SpSubview<eT>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
void SpSubview_row<eT>::operator=(const SpSubview_row<eT>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> template<typename T1> inline
void SpSubview_row<eT>::operator=(const SpBase<eT, T1>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> template<typename T1> inline
void SpSubview_row<eT>::operator=(const Base<eT, T1>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
const SpOp<SpSubview_row<eT>, spop_htrans> SpSubview_row<eT>::t() const { return SpOp<SpSubview_row<eT>, spop_htrans>(*this); }

template<typename eT> inline
const SpOp<SpSubview_row<eT>, spop_htrans> SpSubview_row<eT>::ht() const { return SpOp<SpSubview_row<eT>, spop_htrans>(*this); }

template<typename eT> inline
const SpOp<SpSubview_row<eT>, spop_strans> SpSubview_row<eT>::st() const { return SpOp<SpSubview_row<eT>, spop_strans>(*this); }
