...
eT auxlib::det_tinymat(const Mat<eT>& X, const uword N) {
	...
	case 2: { return (Xm[pos<0, 0>::n2] * Xm[pos<1, 1>::n2] - Xm[pos<0, 1>::n2] * Xm[pos<1, 0>::n2]); }
	break;
...
template<typename T1> inline
bool auxlib::eig_gen_twosided_balance
(
	Mat<std::complex<typename T1::pod_type>>& vals,
	Mat<std::complex<typename T1::pod_type>>& lvecs,
	Mat<std::complex<typename T1::pod_type>>& rvecs,
...
bool auxlib::eig_sym(Col<T>& eigval, const Base<std::complex<T>, T1>& X) {
...
#if defined(ARMA_USE_LAPACK)
	{
		...
		if((arma_config::debug) && (auxlib::rudimentary_sym_check(A) == false)) { arma_debug_warn("eig_sym(): given matrix is not hermitian"); }
...
template<typename eT> inline
bool auxlib::eig_sym(Col<eT>& eigval, Mat<eT>& eigvec, const Mat<eT>& X) {
	arma_extra_debug_sigprint();
...
bool auxlib::eig_sym(Col<T>& eigval, Mat<std::complex<T>>& eigvec, const Mat<std::complex<T>>& X) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool auxlib::eig_sym_dc(Col<eT>& eigval, Mat<eT>& eigvec, const Mat<eT>& X) {
	arma_extra_debug_sigprint();
...
template<typename T> inline
bool auxlib::eig_sym_dc(Col<T>& eigval, Mat<std::complex<T>>& eigvec, const Mat<std::complex<T>>& X) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool auxlib::chol_simple(Mat<eT>& X) {
	arma_extra_debug_sigprint();
...
bool auxlib::qr(Mat<eT>& Q, Mat<eT>& R, const Base<eT, T1>& X) {
...
#if defined(ARMA_USE_LAPACK)
	{
		...
		} else if((is_cx_float<eT>::value) || (is_cx_double<eT>::value)) {
...
bool auxlib::qr_econ(Mat<eT>& Q, Mat<eT>& R, const Base<eT, T1>& X) {
...
#if defined(ARMA_USE_LAPACK)
	{
		...
		for(uword col = 0; col < Q_n_cols; ++col) { for(uword row = 0; row <= col; ++row) { R.at(row, col) = Q.at(row, col); } }
...
template<typename eT, typename T1> inline
bool auxlib::qr_pivot(Mat<eT>& Q, Mat<eT>& R, Mat<uword>& P, const Base<eT, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T, typename T1> inline
bool auxlib::qr_pivot(Mat<std::complex<T>>& Q, Mat<std::complex<T>>& R, Mat<uword>& P, const Base<std::complex<T>, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool auxlib::solve_square_rcond(Mat<typename T1::elem_type>& out, typename T1::pod_type& out_rcond, Mat<typename T1::elem_type>& A, const Base<typename T1::elem_type, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool auxlib::solve_sympd_rcond(Mat<typename T1::pod_type>& out, typename T1::pod_type& out_rcond, Mat<typename T1::pod_type>& A, const Base<typename T1::pod_type, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool auxlib::solve_sympd_rcond(Mat<std::complex<typename T1::pod_type>>& out, typename T1::pod_type& out_rcond, Mat<std::complex<typename T1::pod_type>>& A, const Base<std::complex<typename T1::pod_type>, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool auxlib::solve_rect_fast(Mat<typename T1::elem_type>& out, Mat<typename T1::elem_type>& A, const Base<typename T1::elem_type, T1>& B_expr) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool auxlib::solve_rect_rcond(Mat<typename T1::elem_type>& out, typename T1::pod_type& out_rcond, Mat<typename T1::elem_type>& A, const Base<typename T1::elem_type, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
#if defined(ARMA_USE_LAPACK)
	{
		...
		if(A.n_rows >= A.n_cols) {
			...
			for(uword col = 0; col < A.n_cols; ++col) { for(uword row = 0; row <= col; ++row) { R.at(row, col) = A.at(row, col); } }
			...
			for(uword col = 0; col < A.n_rows; ++col) { for(uword row = col; row < A.n_rows; ++row) { L.at(row, col) = A.at(row, col); } }
...
template<typename T1> inline
bool auxlib::solve_trimat_fast(Mat<typename T1::elem_type>& out, const Mat<typename T1::elem_type>& A, const Base<typename T1::elem_type, T1>& B_expr, const uword layout) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool auxlib::solve_trimat_rcond(Mat<typename T1::elem_type>& out, typename T1::pod_type& out_rcond, const Mat<typename T1::elem_type>& A, const Base<typename T1::elem_type, T1>& B_expr, const uword layout, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
//! solve a system of linear equations via LU decomposition (real band matrix)
template<typename T1> inline
bool auxlib::solve_band_rcond(Mat<typename T1::pod_type>& out, typename T1::pod_type& out_rcond, Mat<typename T1::pod_type>& A, const uword KL, const uword KU, const Base<typename T1::pod_type, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
//! solve a system of linear equations via LU decomposition (complex band matrix)
template<typename T1> inline
bool auxlib::solve_band_rcond(Mat<std::complex<typename T1::pod_type>>& out, typename T1::pod_type& out_rcond, Mat<std::complex<typename T1::pod_type>>& A, const uword KL, const uword KU, const Base<std::complex<typename T1::pod_type>, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
//! solve a system of linear equations via LU decomposition (band matrix)
template<typename T1> inline
bool auxlib::solve_band_rcond_common(Mat<typename T1::elem_type>& out, typename T1::pod_type& out_rcond, const Mat<typename T1::elem_type>& A, const uword KL, const uword KU, const Base<typename T1::elem_type, T1>& B_expr, const bool allow_ugly) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
eT auxlib::rcond_trimat(const Mat<eT>& A, const uword layout) {
#if defined(ARMA_USE_LAPACK)
	{
		arma_debug_assert_blas_size(A);
...
template<typename T> inline
T auxlib::rcond_trimat(const Mat<std::complex<T>>& A, const uword layout) {
#if defined(ARMA_USE_LAPACK)
	{
		typedef typename std::complex<T> eT;
...
template<typename eT> inline
eT auxlib::lu_rcond(const Mat<eT>& A, const eT norm_val) {
#if defined(ARMA_USE_LAPACK)
	{
		char norm_id = '1';
		blas_int n = blas_int(A.n_rows); // assuming square matrix
...
template<typename T> inline
T auxlib::lu_rcond(const Mat<std::complex<T>>& A, const T norm_val) {
#if defined(ARMA_USE_LAPACK)
	{
		typedef typename std::complex<T> eT;
...
template<typename eT> inline
eT auxlib::lu_rcond_sympd(const Mat<eT>& A, const eT norm_val) {
#if defined(ARMA_USE_LAPACK)
	{
		char uplo = 'L';
		blas_int n = blas_int(A.n_rows); // assuming square matrix
...
template<typename T> inline
T auxlib::lu_rcond_sympd(const Mat<std::complex<T>>& A, const T norm_val) {
#if defined(ARMA_CRIPPLED_LAPACK)
    {
    arma_ignore(A);
    arma_ignore(norm_val);
...
template<typename eT> inline
eT auxlib::lu_rcond_band(const Mat<eT>& AB, const uword KL, const uword KU, const podarray<blas_int>& ipiv, const eT norm_val) {
#if defined(ARMA_USE_LAPACK)
	{
		const uword N = AB.n_cols; // order of the original square matrix A
...
template<typename T> inline
T auxlib::lu_rcond_band(const Mat<std::complex<T>>& AB, const uword KL, const uword KU, const podarray<blas_int>& ipiv, const T norm_val) {
#if defined(ARMA_CRIPPLED_LAPACK)
    {
    arma_ignore(AB);
    arma_ignore(KL);
...
template<typename T1> inline
typename T1::pod_type auxlib::epsilon_lapack(const Base<typename T1::elem_type, T1>&) {
	typedef typename T1::pod_type T;
...
template<typename eT> inline
bool auxlib::rudimentary_sym_check(const Mat<eT>& X) {
	arma_extra_debug_sigprint();
...
template<typename T> inline
bool auxlib::rudimentary_sym_check(const Mat<std::complex<T>>& X) {
	arma_extra_debug_sigprint();
