...
>::result var(const T1& X, const uword norm_type = 0) {
...
<
	...
	const mtOp<typename T1::pod_type, T1, op_var>>::result var(const T1& X, const uword norm_type = 0) {
	arma_extra_debug_sigprint();
...
<
	...
	const mtOp<typename T1::pod_type, T1, op_var>>::result var(const T1& X, const uword norm_type, const uword dim) {
	arma_extra_debug_sigprint();
...
arma_inline
typename arma_scalar_only<T>::result var(const T&) { return T(0); }
...
<
	...
	const mtSpOp<typename T1::pod_type, T1, spop_var>>::result var(const T1& X, const uword norm_type = 0) {
	arma_extra_debug_sigprint();
...
<
	...
	const mtSpOp<typename T1::pod_type, T1, spop_var>>::result var(const T1& X, const uword norm_type, const uword dim) {
	arma_extra_debug_sigprint();
