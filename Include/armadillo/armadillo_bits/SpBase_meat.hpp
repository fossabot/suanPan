...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_symmetric() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_symmetric(const typename get_pod_type<elem_type>::result tol) const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_hermitian() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_hermitian(const typename get_pod_type<elem_type>::result tol) const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_zero(const typename get_pod_type<elem_type>::result tol) const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_trimatu() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_trimatl() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_diagmat() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_empty() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_square() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_vec() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_colvec() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_rowvec() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::is_finite() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::has_inf() const {
	arma_extra_debug_sigprint();
...
template<typename elem_type, typename derived> inline
arma_warn_unused
bool SpBase<elem_type, derived>::has_nan() const {
	arma_extra_debug_sigprint();
