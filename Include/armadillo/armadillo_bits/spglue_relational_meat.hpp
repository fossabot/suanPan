...
void spglue_rel_lt::apply(SpMat<uword>& out, const mtSpGlue<uword, T1, T2, spglue_rel_lt>& X) {
...
template<typename T1, typename T2> inline
void spglue_rel_lt::apply_noalias(SpMat<uword>& out, const SpProxy<T1>& PA, const SpProxy<T2>& PB) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_rel_gt::apply(SpMat<uword>& out, const mtSpGlue<uword, T1, T2, spglue_rel_gt>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_rel_gt::apply_noalias(SpMat<uword>& out, const SpProxy<T1>& PA, const SpProxy<T2>& PB) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_rel_and::apply(SpMat<uword>& out, const mtSpGlue<uword, T1, T2, spglue_rel_and>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_rel_and::apply_noalias(SpMat<uword>& out, const SpProxy<T1>& PA, const SpProxy<T2>& PB) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_rel_or::apply(SpMat<uword>& out, const mtSpGlue<uword, T1, T2, spglue_rel_or>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_rel_or::apply_noalias(SpMat<uword>& out, const SpProxy<T1>& PA, const SpProxy<T2>& PB) {
	arma_extra_debug_sigprint();
