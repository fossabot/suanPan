...
void spglue_join_cols::apply(SpMat<eT>& out, const SpBase<eT, T1>& A_expr, const SpBase<eT, T2>& B_expr, const SpBase<eT, T3>& C_expr) {
	arma_extra_debug_sigprint();
...
void spglue_join_cols::apply(SpMat<eT>& out, const SpBase<eT, T1>& A_expr, const SpBase<eT, T2>& B_expr, const SpBase<eT, T3>& C_expr, const SpBase<eT, T4>& D_expr) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1, typename T2, typename T3> inline
void spglue_join_rows::apply(SpMat<eT>& out, const SpBase<eT, T1>& A_expr, const SpBase<eT, T2>& B_expr, const SpBase<eT, T3>& C_expr) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1, typename T2, typename T3, typename T4> inline
void spglue_join_rows::apply(SpMat<eT>& out, const SpBase<eT, T1>& A_expr, const SpBase<eT, T2>& B_expr, const SpBase<eT, T3>& C_expr, const SpBase<eT, T4>& D_expr) {
	arma_extra_debug_sigprint();
