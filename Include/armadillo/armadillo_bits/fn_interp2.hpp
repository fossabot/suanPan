...
void interp2_helper_nearest(const Mat<eT>& XG, const Mat<eT>& ZG, const Mat<eT>& XI, Mat<eT>& ZI, const eT extrap_val, const uword mode) {
...
template<typename eT> inline
void interp2_helper_linear(const Mat<eT>& XG, const Mat<eT>& ZG, const Mat<eT>& XI, Mat<eT>& ZI, const eT extrap_val, const uword mode) {
	arma_extra_debug_sigprint();
...
typename
enable_if2<is_real<typename T1::elem_type>::value, void>::result interp2
(
