...
typename enable_if2<(is_real<typename T1::elem_type>::value), void>::result log_normpdf_helper(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& X_expr, const Base<typename T1::elem_type, T2>& M_expr, const Base<typename T1::elem_type, T3>& S_expr) {
...
arma_warn_unused
typename enable_if2<(is_real<eT>::value), eT>::result log_normpdf(const eT x) {
...
template<typename eT> inline
arma_warn_unused
typename enable_if2<(is_real<eT>::value), eT>::result log_normpdf(const eT x, const eT mu, const eT sigma) {
...
arma_warn_unused
typename enable_if2<(is_real<eT>::value), Mat<eT>>::result log_normpdf(const eT x, const Base<eT, T2>& M_expr, const Base<eT, T3>& S_expr) {
	arma_extra_debug_sigprint();
...
arma_warn_unused
typename enable_if2<(is_real<typename T1::elem_type>::value), Mat<typename T1::elem_type>>::result log_normpdf(const Base<typename T1::elem_type, T1>& X_expr) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
arma_warn_unused
typename enable_if2<(is_real<typename T1::elem_type>::value), Mat<typename T1::elem_type>>::result log_normpdf(const Base<typename T1::elem_type, T1>& X_expr, const typename T1::elem_type mu, const typename T1::elem_type sigma) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2, typename T3> inline
arma_warn_unused
typename enable_if2<(is_real<typename T1::elem_type>::value), Mat<typename T1::elem_type>>::result log_normpdf(const Base<typename T1::elem_type, T1>& X_expr, const Base<typename T1::elem_type, T2>& M_expr, const Base<typename T1::elem_type, T3>& S_expr) {
	arma_extra_debug_sigprint();
