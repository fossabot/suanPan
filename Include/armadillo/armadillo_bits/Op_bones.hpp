...
template<typename T1, typename op_type, bool condition> struct Op_traits {};

template<typename T1, typename op_type> struct Op_traits<T1, op_type, true> {
...
template<typename T1, typename op_type> struct Op_traits<T1, op_type, false> {
