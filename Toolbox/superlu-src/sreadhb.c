 ...
 * </pre>
 */
static void FormFullA(int n, int* nonz, float** nzval, int** rowind, int** colptr) {
...
void sreadhb(FILE* fp, int* nrow, int* ncol, int* nonz,
	...
	if(numer_lines) { sReadValues(fp, *nonz, *nzval, valnum, valsize); }
