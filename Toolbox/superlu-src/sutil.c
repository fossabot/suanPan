...
void sCreate_Dense_Matrix(SuperMatrix* X, int m, int n, float* x, int ldx,
                          Stype_t stype, Dtype_t dtype, Mtype_t mtype) {
	DNformat* Xstore;
...
void sCopy_Dense_Matrix(int M, int N, float* X, int ldx,
                        float* Y, int ldy) {
 ...
 */
void sFillRHS(trans_t trans, int nrhs, float* x, int ldx,
