...
void dCreate_CompCol_Matrix(SuperMatrix* A, int_t m, int_t n, int_t nnz, double* nzval,
...
void dCreate_CompCol_Permuted(SuperMatrix* A, int_t m, int_t n, int_t nnz, double* nzval,
 ...
 */
void dCompRow_to_CompCol(int_t m, int_t n, int_t nnz,
...
void dCopy_CompCol_Matrix(SuperMatrix* A, SuperMatrix* B) {
	...
	for(i = 0; i < nnz; ++i) ((double*)Bstore->nzval)[i] = ((double*)Astore->nzval)[i];
...
void dCreate_Dense_Matrix(SuperMatrix* X, int_t m, int_t n, double* x, int_t ldx,
                          Stype_t stype, Dtype_t dtype, Mtype_t mtype) {
	DNformat* Xstore;
...
void dCreate_SuperNode_Matrix(SuperMatrix* L, int_t m, int_t n, int_t nnz, double* nzval,
...
void dCreate_SuperNode_Permuted(SuperMatrix* L, int_t m, int_t n, int_t nnz,
                                double* nzval,
 ...
 */
void dprint_lu_col(int_t pnum, char* msg, int_t pcol, int_t jcol, int_t w, int_t pivrow,
...
void dcheck_zero_vec(int_t pnum, char* msg, int_t n, double* vec) {
	...
	} else { printf(".. Normal exit dcheck_zero_vec() ..\n"); }
}
...
void dPrintPerf(SuperMatrix* L, SuperMatrix* U, superlu_memusage_t* superlu_memusage,
