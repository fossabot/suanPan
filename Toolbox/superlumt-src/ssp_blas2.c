...
int_t sp_strsv(char* uplo, char* trans, char* diag, SuperMatrix* L,
	 ...
	 *	        U has types: Stype = NCP, Dtype = _S, Mtype = TRU.
	 *    
...
int_t sp_sgemv(char* trans, float alpha, SuperMatrix* A, float* x,
