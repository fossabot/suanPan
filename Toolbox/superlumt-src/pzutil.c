...
void zCreate_CompCol_Matrix(SuperMatrix* A, int_t m, int_t n, int_t nnz, doublecomplex* nzval,
...
void zCreate_CompRow_Matrix(SuperMatrix* A, int_t m, int_t n, int_t nnz, doublecomplex* nzval,
...
void zCreate_CompCol_Permuted(SuperMatrix* A, int_t m, int_t n, int_t nnz, doublecomplex* nzval,
 ...
 */
void zCompRow_to_CompCol(int_t m, int_t n, int_t nnz,
...
void zCopy_CompCol_Matrix(SuperMatrix* A, SuperMatrix* B) {
	...
	for(i = 0; i < nnz; ++i) ((doublecomplex*)Bstore->nzval)[i] = ((doublecomplex*)Astore->nzval)[i];
...
void zCreate_Dense_Matrix(SuperMatrix* X, int_t m, int_t n, doublecomplex* x, int_t ldx,
                          Stype_t stype, Dtype_t dtype, Mtype_t mtype) {
	DNformat* Xstore;
...
void zCopy_Dense_Matrix(int_t M, int_t N, doublecomplex* X, int_t ldx, doublecomplex* Y, int_t ldy) {
	/*
	 *
	 *  Purpose
	 *  =======
...
void zCreate_SuperNode_Matrix(SuperMatrix* L, int_t m, int_t n, int_t nnz, doublecomplex* nzval,
...
void zCreate_SuperNode_Permuted(SuperMatrix* L, int_t m, int_t n, int_t nnz,
                                doublecomplex* nzval,
 ...
 */
void zprint_lu_col(int_t pnum, char* msg, int_t pcol, int_t jcol, int_t w, int_t pivrow,
 ...
 */
void zcheck_zero_vec(int_t pnum, char* msg, int_t n, doublecomplex* vec) {
 ...
 */
void zFillRHS(trans_t trans, int_t nrhs, doublecomplex* x, int_t ldx, SuperMatrix* A, SuperMatrix* B) {
	NCformat* Astore;
	doublecomplex* Aval;
	DNformat* Bstore;
	doublecomplex* rhs;
 ...
 */
void zfill(doublecomplex* a, int_t alen, doublecomplex dval) {
	register int_t i;
...
void zPrintPerf(SuperMatrix* L, SuperMatrix* U, superlu_memusage_t* superlu_memusage,
