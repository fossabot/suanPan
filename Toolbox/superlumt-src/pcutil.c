...
void cCreate_CompCol_Matrix(SuperMatrix* A, int_t m, int_t n, int_t nnz, complex* nzval,
...
void cCreate_CompRow_Matrix(SuperMatrix* A, int_t m, int_t n, int_t nnz, complex* nzval,
...
void cCreate_CompCol_Permuted(SuperMatrix* A, int_t m, int_t n, int_t nnz, complex* nzval,
 ...
 */
void cCompRow_to_CompCol(int_t m, int_t n, int_t nnz,
...
void cCopy_CompCol_Matrix(SuperMatrix* A, SuperMatrix* B) {
	...
	for(i = 0; i < nnz; ++i) ((complex*)Bstore->nzval)[i] = ((complex*)Astore->nzval)[i];
...
void cCreate_Dense_Matrix(SuperMatrix* X, int_t m, int_t n, complex* x, int_t ldx,
                          Stype_t stype, Dtype_t dtype, Mtype_t mtype) {
	DNformat* Xstore;
...
void cCopy_Dense_Matrix(int_t M, int_t N, complex* X, int_t ldx, complex* Y, int_t ldy) {
	/*
	 *
	 *  Purpose
	 *  =======
...
void cCreate_SuperNode_Matrix(SuperMatrix* L, int_t m, int_t n, int_t nnz, complex* nzval,
...
void cCreate_SuperNode_Permuted(SuperMatrix* L, int_t m, int_t n, int_t nnz,
                                complex* nzval,
 ...
 */
void cprint_lu_col(int_t pnum, char* msg, int_t pcol, int_t jcol, int_t w, int_t pivrow,
 ...
 */
void ccheck_zero_vec(int_t pnum, char* msg, int_t n, complex* vec) {
 ...
 */
void cFillRHS(trans_t trans, int_t nrhs, complex* x, int_t ldx, SuperMatrix* A, SuperMatrix* B) {
	NCformat* Astore;
	complex* Aval;
	DNformat* Bstore;
	complex* rhs;
 ...
 */
void cfill(complex* a, int_t alen, complex dval) {
	register int_t i;
...
void cPrintPerf(SuperMatrix* L, SuperMatrix* U, superlu_memusage_t* superlu_memusage,
