...
int_t sp_ctrsv(char* uplo, char* trans, char* diag, SuperMatrix* L,
	 ...
	 *	        U has types: Stype = NCP, Dtype = _C, Mtype = TRU.
	 *    
	...
	*info = 0;
	...
	SUPERLU_ABORT("Malloc fails for work in sp_ctrsv().");
...
int_t sp_cgemv(char* trans, complex alpha, SuperMatrix* A, complex* x,
