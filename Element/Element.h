...
class Element : protected ElementData, public ElementBase {
	...
	friend void ConstantMass(ElementData*);
	friend void ConstantDamping(ElementData*);
	friend void ConstantStiffness(ElementData*);
	friend void ConstantGeometry(ElementData*);
