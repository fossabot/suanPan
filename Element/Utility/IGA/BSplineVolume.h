...
public:
	explicit BSplineVolume(vec, vec, vec, uword, field<vec>&& = {}); // lgtm [cpp/large-parameter]
...
public:
	explicit BSplineVolume3D(vec, vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class BSplineVolume4D final : public BSplineVolume {
public:
	explicit BSplineVolume4D(vec, vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};
