...
public:
	explicit BSplineSurface(vec, vec, uword, field<vec>&& = {}); // lgtm [cpp/large-parameter]
...
public:
	explicit BSplineSurface2D(vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class BSplineSurface3D final : public BSplineSurface {
public:
	explicit BSplineSurface3D(vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class BSplineSurface4D final : public BSplineSurface {
public:
	explicit BSplineSurface4D(vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};
