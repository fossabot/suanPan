...
public:
	explicit NURBSSurface2D(vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class NURBSSurface3D final : public NURBSSurface {
public:
	explicit NURBSSurface3D(vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class NURBSSurface4D final : public NURBSSurface {
public:
	explicit NURBSSurface4D(vec, vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};
