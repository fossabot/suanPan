...
public:
	explicit NURBSCurve2D(vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class NURBSCurve3D final : public NURBS {
public:
	explicit NURBSCurve3D(vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class NURBSCurve4D final : public NURBS {
public:
	explicit NURBSCurve4D(vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};
