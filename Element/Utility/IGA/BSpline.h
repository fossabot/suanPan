...
public:
	BSpline(vec, uword, field<vec>&& = {}); // lgtm [cpp/large-parameter]
...
public:
	explicit BSplineCurve2D(vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class BSplineCurve3D final : public BSpline {
public:
	explicit BSplineCurve3D(vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};

class BSplineCurve4D final : public BSpline {
public:
	explicit BSplineCurve4D(vec, field<vec>&& = {}); // lgtm [cpp/large-parameter]
};
