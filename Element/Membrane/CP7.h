...
/**
 * @class CP7
 * @brief The CP7 class handles CPS5, CPE5, CPS5R and CPE5R elements. It is a
...
class CP7 final : public MaterialElement2D {
	...
	static constexpr unsigned m_node = 7, m_dof = 2, m_size = m_dof * m_node;
