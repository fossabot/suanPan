...
if(USE_MKL)
    set(MKLROOT "" CACHE PATH "MKL library path which contains /mkl and /compiler folder.")
    find_file(MKL_HEADER NAMES mkl.h PATHS ${MKLROOT}/mkl/include)
    if(MKL_HEADER MATCHES "MKL_HEADER-NOTFOUND")
        message(FATAL_ERROR "The mkl.h is not found under the given path.")
    endif()
...
if(USE_EXTERNAL_MAGMA)
    find_library(MAGMA_LIBRARY magma.lib)
    if(MAGMA_LIBRARY MATCHES "MAGMA_LIBRARY-NOTFOUND")
        message("MAGMA library is not found, please indicate its location.")
        set(MAGMA_PATH "" CACHE PATH "MAGMA library path which contains magma.lib file.")
        find_library(MAGMA_LIBRARY magma.lib PATHS ${MAGMA_PATH})
    else()
        find_package(CUDA)
        if(NOT CUDA_FOUND)
        ...
        include_directories(${ROOT}/Include/magma)
        link_libraries(${CUDA_LIBRARIES})
        link_libraries(magma.lib magma_sparse.lib)
    endif()
endif()
