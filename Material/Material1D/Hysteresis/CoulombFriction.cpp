...
void CoulombFriction::initialize(const shared_ptr<DomainBase>&) { trial_damping = current_damping = initial_damping = friction_force * factor; }
...
void CoulombFriction::print() { suanpan_info("A Coulumb friction model.\n"); }
